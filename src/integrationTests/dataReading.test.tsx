...
describe("dashboard algebraic sum", () => {
  it("shows correct savings total from seeded incomes and expenses", async () => {
    seedEntries([
      { date: ts(YEAR_2026, MAY_2026), amount: "1000", type: "income", categories_path: ",salary," },
      { date: ts(YEAR_2026, MAY_2026), amount: "500",  type: "income", categories_path: ",deposit," },
      { date: ts(YEAR_2026, MAY_2026), amount: "200",  type: "expense", categories_path: ",food," },
      { date: ts(YEAR_2026, MAY_2026), amount: "100",  type: "expense", categories_path: ",eating out," },
    ]);
...
describe("edit / delete", () => {
  it("reflects updated amount after editing an expense", async () => {
    const [seeded] = seedEntries([
      { date: ts(YEAR_2026, MAY_2026), amount: "50", type: "expense", categories_path: ",food,", description: "Groceries" },
    ]);
...
describe("/incomes route", () => {
  it("shows seeded incomes with correct total", async () => {
    seedEntries([
      { date: ts(YEAR_2026, MAY_2026), amount: "800",  type: "income", categories_path: ",salary,",  description: "Paycheck" },
      { date: ts(YEAR_2026, MAY_2026), amount: "200",  type: "income", categories_path: ",deposit,", description: "Transfer" },
    ]);
...
describe("/expenses route", () => {
  it("shows seeded expenses with correct total", async () => {
    seedEntries([
      { date: ts(YEAR_2026, MAY_2026), amount: "120", type: "expense", categories_path: ",food,",       description: "Supermarket" },
      { date: ts(YEAR_2026, MAY_2026), amount: "30",  type: "expense", categories_path: ",eating out,", description: "Lunch" },
    ]);
...
describe("/summary route", () => {
  ...
  it("shows all entries with combined total by default", async () => {
    seedEntries([
      { date: ts(YEAR_2026, MAY_2026), amount: "1000", type: "income",  categories_path: ",salary,",     description: "Pay" },
      { date: ts(YEAR_2026, MAY_2026), amount: "200",  type: "expense", categories_path: ",eating out,", description: "Dinner" },
    ]);
